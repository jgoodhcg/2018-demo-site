(defproject demo-site "0.1.0-SNAPSHOT"
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "demo-site.core/mount-components"}
                     :compiler
                     {:main "demo-site.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
